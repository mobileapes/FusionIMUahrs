...
void configIMU() {
  ...
  // Orientation
  // Check your board
  // 9 Degrees of Freedom - Sensor Stick - ITG3200/ADXL345/HMC5883L
  // Axis definition:
...
// function to pass as an argument to read magnetometer data.
void read_compass(int *axes) {
  // Retrive the raw values from the compass (not scaled).
  MagnetometerRaw raw = compass.ReadRawAxis(); // return integer
  axes[0] = raw.XAxis;
  axes[1] = raw.YAxis;
  axes[2] = raw.ZAxis;
